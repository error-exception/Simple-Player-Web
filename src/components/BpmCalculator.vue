            ...
            >
                ...
                <Column class="fill-width block-box" :gap="12">
                    ...
                    <Row class="fill-width font-white" :gap="16" center-horizontal>
                        ...
                        <button class="radio-btn" @click="state.precisionIndex = 1"
                                :style="`background-color: ${ state.precisionIndex == 1 ? '#33cb98' : 'transparent'}`">
                            10.0
                        </button>
                        <button class="radio-btn" @click="state.precisionIndex = 2"
                                :style="`background-color: ${ state.precisionIndex == 2 ? '#33cb98' : 'transparent'}`">
                            100.0
                        </button>
                        <button class="radio-btn" @click="state.precisionIndex = 3"
                                :style="`background-color: ${ state.precisionIndex == 3 ? '#33cb98' : 'transparent'}`">
                            beat gap
                        </button>
                    </Row>
                </Column>
