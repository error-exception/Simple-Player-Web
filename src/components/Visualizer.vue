...
<!--    <img :src="logo" width="270" height="270" ref="logo" alt="logo" style="position: absolute">-->
<!--    <img :src="logo" width="270" height="270" ref="logo_out" alt="logo" style="position: absolute; opacity: .1;">-->
